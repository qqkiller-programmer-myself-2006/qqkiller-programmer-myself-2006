...
<p align="center">
  <strong>Full-Stack Developer · Computer Science Year 3 · Loei Rajabhat University</strong><br>
  I build practical web interfaces, backend services, and API-driven products.
</p>

## What I Build

| Web Experiences | Backend and APIs | Product Systems |
|---|---|---|
| Responsive interfaces with React, Next.js, Tailwind CSS, HTML, CSS, and JavaScript. | REST APIs and services with Node.js, Express.js, Python, PHP, and MySQL. | Full-stack applications, developer tools, and mobile-oriented product ideas. |
...
<!-- GitHub stats will be restored here after the self-hosted Vercel endpoint is configured. -->
